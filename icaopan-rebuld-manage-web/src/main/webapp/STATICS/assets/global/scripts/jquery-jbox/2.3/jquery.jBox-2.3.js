...
(function (a) {
	a.jBox = function (b, c) {
		...
		j.push('<div class="jbox-help-title jbox-title-panel" style="height:42px;display:none;"></div>');
		j.push('<div class="jbox-help-button jbox-button-panel" style="height:36px;padding:5px 0 5px 0;display:none;"></div>');
		...
		if (g) {
			j.push('<div class="jbox-title-panel" style="height:42px;">');
		...
		a.each(b, function (N, O) {
			...
			r.push('<div class="jbox-button-panel" style="height:36px;padding:5px 0 5px 0;text-align: right;' + (P ? '' : 'display:none;') + '">');
			if (!c.isTip) {
