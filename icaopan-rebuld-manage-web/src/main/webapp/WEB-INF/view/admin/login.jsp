		...
		<div class="row">
			...
			<div class="col-md-4">
				<form class="login-form" id="login-form">
					<%-- <img src="${pageContext.request.contextPath}/STATICS/icaopan-img/logo1.png" class="logo"/> --%>
					...
					<div class="form-actions">
						<label class="checkbox re-box"><input type="checkbox" name="remember" value="1" /> 记住我</label>
