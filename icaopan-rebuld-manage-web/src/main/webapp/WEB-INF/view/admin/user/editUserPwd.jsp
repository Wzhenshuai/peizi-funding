...
<div class="portlet box red">
	...
	<div class="portlet-body">
		<div class="table-responsive">
				<form id="inputForm" modelAttribute="adminUser" class="form-horizontal">
					<div class="modal-body">
						<input type="hidden" name="id" value="${adminUser.id}"/>
						<div class="form-group">
							<label class="col-sm-3 control-label">用户名<span class="help-inline"><font color="red">*</font> </span>:</label>
							<div class="col-sm-3">
								<input name="userName" id="userName" value="${adminUser.userName}" readonly class="form-control bg-success" maxlength="50" class="required"/>
							</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<input name="userName" id="realName" value="${adminUser.realName}" readonly class="form-control bg-success" maxlength="50" class="required"/>
							</div>
						</div>
						<div class="form-group">
