...
<div class="portlet-body">
	<div class="table-responsive">
			...
			<table:table headerNames="券商名称,资金账号,交易账号,交易密码,通讯密码,营业部名称,状态,用户备注,管理员备注,创建时间,更新时间,操作"
						 columnNames="securityName,cashAccount,tradeAccount,jyPass,txPass,yybName,statusStr,notes,adminNotes,createTimeStr,updateTimeStr"
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="form-group col-md-8 col-md-offset-3">
						<label class="col-sm-4 control-label">资金账户</label>
						<div class="col-sm-4">
							<span id="cashAmount" class="b"></span>
						</div>
					</div>
