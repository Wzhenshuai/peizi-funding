				...
				<div id="exTab1" class="container col-sm-offset-1">
					...
					<div class="tab-content clearfix">
						<ul  class="nav nav-tabs">
							...
							<li><a href="#3a" data-toggle="tab">交易费用</a>
							</li>
							<li><a href="#4a" data-toggle="tab">本金及融资金额</a>
							</li>
						...
						<div class="tab-pane active" id="1a">
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									<input type="text" value="${user.realName}" name="realName" class="form-control" htmlEscape="false" maxlength="100"/>
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-2 control-label">所属资金方:</label>
								<div class="col-sm-4"><input type="hidden" id="customerId" value="${user.customer.id}">
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									<label class="radio-inline"><input id="normalUser" type="radio" name="userClassTypeVal" value="0">普通用户</label>
									<label class="radio-inline"><input id="advancedUser" type="radio" name="userClassTypeVal" value="1">高级用户</label>
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<label class="col-sm-2 control-label">关联账户:<br><br><span id="btnRelated" class="btn btn-danger btn-xs">添加</span></label>
								<div class="col-sm-4">
						...
						<div class="tab-pane" id="4a">
							<div class="form-group">
								...
								<div class="col-sm-4">
									<input type="number" value="${user.cashAmount}" name="cashAmount" class="form-control" htmlEscape="false" maxlength="100"/>
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-2 control-label">融资金额:</label>
								<div class="col-sm-4">
									<input type="number" value="${user.financeAmount}" name="financeAmount" class="form-control" htmlEscape="false" maxlength="100"/>
								</div>
							</div>
						...
						<div class="col-md-9 col-md-offset-3">
							<div class="form-group">
								...
								<div class="col-sm-4">
									...
									<input type="button" onclick="history.go(-1)" class="btn btn-default btn-sm" value="取 消"/>
								</div>
							</div>
						</div>
					</div>
		...
		$.ajax({
			...
			"success" : function(result) {
				...
				for(var i = 0 ; i<result.length ;i++){
					...
					var td3 = document.createElement("td");
					tr.appendChild(td3);
					td3.innerHTML="<button type='button' onclick='add(this)' class='btn btn-danger btn-xs'><i class='glyphicon glyphicon-plus'></i></button>";
					tbodyRelated.appendChild(tr);
				}
				tableRelated.appendChild(theadRelated);
				tableRelated.appendChild(tbodyRelated);
...
//                $("#riskDownAmplitude").val(0);
	...
	function del(obj){
		...
		$("#freeTable").append("<tr><td>"+no+"<input type='hidden' name='userChannelTypeValHidden' value='" + userChannelTypeValHidden +"'/><input type='hidden' name='quotaHidden' value='"+ quotaHidden +"'/><input type='hidden' name='proportionHidden' value='"+ proportionHidden +"'/></td><td>"+name+"</td><td>"+amount+"</td><td><button type='button' onclick='add(this)' class='btn btn-danger btn-xs'><i class='glyphicon glyphicon-plus'></i></button></td></tr>");
		objParentTR.remove();
	}
