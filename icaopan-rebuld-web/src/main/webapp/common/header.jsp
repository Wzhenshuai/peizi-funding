     	...
     	<div class="wrap clearfix">
     		<div class="tab dropdown">
				...
				<ul class="subnav">
					<div class="ewm-xs-left">
						<a href="<%=basePath%>mobile/download.jsp"><img src="<%=basePath%>images/app_download.png" width="107px" height="107px"></a>
					</div>
     		...
     		<c:choose>
				<c:when test="${!empty sessionScope.user }">
					<div id="userFlagPic" style="float:left;display:block;margin-left:630px; margin-top:8px;height:26px;"><i class="ui-icon i-user-gray12"></i></div>
					<c:choose>
						<c:when test="${!empty sessionScope.user.realName}">
							<c:choose>
								...
								<c:otherwise>
									<span class="mar-l5" style="display:block;float:left;">${sessionScope.user.realName }</span>
								</c:otherwise>
							</c:choose>
						</c:when>
						<c:otherwise>
							<c:choose>
								...
								<c:otherwise>
									<span class="mar-l5" style="display:block;float:left;">${sessionScope.Toft_SessionKey_UserData.usernameHidePart }</span>
								</c:otherwise>
							</c:choose>
						</c:otherwise>
					</c:choose>
			...
			<div sytle="display:block;float:right;">
		         <a href="<%=basePath%>user/LogOut.do" >安全退出</a>
		    </div>
         </div>
