	...
	<div id="main">
		<div class="wrap clearfix">
			...
			<div class="main-cont fr">
				...
				<div style="margin-top:20px"><!-- 这个空div用来设定table高度不要删除 -->
					<table id="wdccTable" class="wycg-table">
						<tr><th width="30"></th><th width="96" class="txt-l">股票简称</th><th width="115">股票市值</th><th width="128">浮动盈亏/比例</th><th width="120">持股/可用</th><th width="104">现价</th><th width="98">成本价</th><th></th></tr>
					</table>
