function ShowWypzDia(title, amount, level,circle , interest, duedate,sureButtonText, surecallback, cancelButtonText, cancelcallback){
	this.title=title;
	this.circle=circle;
	...
	this.show=function(){
		...
		html += "    <td><label>";
		html += "      <select name='' id='circles' onchange='DF.changeCircle(this , "+level+","+amount+");'>";
...
function UpdateDialog(title, text, sureButtonText, surecallback,cancelButtonText,cancelcallback){
	...
	this.sureButtonClick = function(obj) {
		if(obj!=undefined){
	...
	this.show=function(){
		...
		+       this.text
		+'  <div class="pop-btn"><input name="" type="button" value='+this.sureButtonText+' class="inp-btn" onclick="sureButtonClick(this)"/>'
		+'<input name="" class="cancel" type="button"  value='+cancelButtonText+' onclick="closeDia()"></div>'
		+'</div>'
		+' </div>';
		$("body").append(html);
...
function TryChargeDialog(title, text, sureButtonText, surecallback,cancelButtonText,cancelcallback){
	this.title=title;
	this.text=text;
	this.sureButtonText=sureButtonText;
	this.cancelButtonText=cancelButtonText;
