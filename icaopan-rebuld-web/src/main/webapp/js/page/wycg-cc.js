		...
		success:function(r) {
			...
			if (list != null && list.length > 0) {
				...
				for (var i = 0; i < list.length; i++) {
					...
					html+='<a class="btn4 btn4-blue mar-t5" href='+systemConfig.path+"/trade/SellStocksInit.do?stockCode="+securityLocalCode+'>卖出</a>';
					html += "</td></tr>";
					isOdd = !isOdd;
				}
...
$(function(){
	...
	//子导航焦点态
	$(".aside-nav li a:contains('我的持仓')").parent("li").addClass('active');
