...
import com.icaopan.web.common.HttpsConnection;
...
public class WebUtil {
    ...
    public static String readContentFromPost(String url, String params)
            throws IOException {
    ...
    public static String readContentFromPostUseHttps(String url, String params)
            throws IOException {
    ...
    public static String makeAllUrl(HttpServletRequest request) {
        ...
        String queryStr = WebUtil.parseUrlParamMap(paraMap);
    ...
    public static String makeAllUrlIndex(HttpServletRequest request) {
        Map<String, String[]> paraMap = request.getParameterMap();
        String queryStr = WebUtil.parseUrlParamMap(paraMap);
        Pattern p = Pattern.compile("\\W");
        Matcher m = p.matcher(queryStr);
    ...
    public static String parseUrlParamMap(Map<String, String[]> parmMap) {
        ...
        for (Map.Entry<String, String[]> entry : parmMap.entrySet()) {
            ...
            urlParamsStr = urlParamsStr.append(entry.getKey()).append("=").append(paramValue.toString()).append("&");
        }
