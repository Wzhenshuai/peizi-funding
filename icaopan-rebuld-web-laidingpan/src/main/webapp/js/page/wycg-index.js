...
MA.queryHoldStock = function(){
	var html = '<tr><th width="100">股票简称</th><th width="115">股票市值</th><th width="128">浮动盈亏/比例</th><th width="120">持股/可用</th><th width="90">现价</th><th width="90">成本价</th><th></th></tr>';
	$.ajax({
...
//					}
					...
					html+='<a class="btn4 btn4-blue mar-l3" href='+systemConfig.path+"/trade/SellStocksInit.do?stockCode="+securityCode+'>卖出</a></td></tr>';
					isOdd = !isOdd;
				}
			} else {
