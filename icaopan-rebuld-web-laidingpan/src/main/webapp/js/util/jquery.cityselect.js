...
C._cityInfo = [
		...
		{"n":"吉林省","c":["长春市","吉林市","四平市","辽源市","通化市","白山市","松原市","白城市","延边"]},
		{"n":"黑龙江省","c":["哈尔滨市","齐齐哈尔市","鹤岗市","双鸭山市","鸡西市","大庆市","伊春市","牡丹江市","佳木斯市","七台河市","黑河市","绥化市","大兴安岭"]},
		...
		{"n":"湖北省","c":["武汉市","黄石市","十堰市","宜昌市","襄樊市","鄂州市","荆门市","孝感市","荆州市","黄冈市","咸宁市","随州市","恩施","仙桃市","潜江市","天门市","神农架林区"]},
		{"n":"湖南省","c":["长沙市","株洲市","湘潭市","衡阳市","邵阳市","岳阳市","常德市","张家界市","益阳市","郴州市","永州市","怀化市","娄底市","湘西"]},
		{"n":"广东省","c":["广州市","深圳市","珠海市","汕头市","韶关市","佛山市","江门市","湛江市","茂名市","肇庆市","惠州市","梅州市","汕尾市","河源市","阳江市","清远市","东莞市","中山市","潮州市","揭阳市","云浮市"]},
		{"n":"甘肃省","c":["兰州市","金昌市","白银市","天水市","嘉峪关市","武威市","张掖市","平凉市","酒泉市","庆阳市","定西市","陇南市","临夏","甘南"]},
		{"n":"四川省","c":["成都市","自贡市","攀枝花市","泸州市","德阳市","绵阳市","广元市","遂宁市","内江市","乐山市","南充市","眉山市","宜宾市","广安市","达州市","雅安市","巴中市","资阳市","阿坝","甘孜","凉山"]},
		{"n":"贵州省","c":["贵阳市","六盘水市","遵义市","安顺市","铜仁市","毕节市","黔西南","黔东南","黔南"]},
		{"n":"海南省","c":["海口市","三亚市","五指山市","琼海市","儋州市","文昌市","万宁市","东方市","澄迈县","定安县","屯昌县","临高县","白沙","昌江","乐东","陵水","保亭","琼中"]},
		{"n":"云南省","c":["昆明市","曲靖市","玉溪市","保山市","昭通市","丽江市","思茅市","临沧市","楚雄","红河","文山","西双版纳","大理","德宏","怒江","迪庆"]},
		{"n":"青海省","c":["西宁市","海东地区","海北","黄南","海南","果洛","玉树","海西"]},
		{"n":"陕西省","c":["西安市","铜川市","宝鸡市","咸阳市","渭南市","延安市","汉中市","榆林市","安康市","商洛市"]},
		{"n":"广西","c":["南宁市","柳州市","桂林市","梧州市","北海市","防城港市","钦州市","贵港市","玉林市","百色市","贺州市","河池市","来宾市","崇左市"]},
		{"n":"西藏","c":["拉萨市","昌都市","山南地区","日喀则地区","那曲地区","阿里地区","林芝市"]},
		{"n":"宁夏","c":["银川市","石嘴山市","吴忠市","固原市","中卫市"]},
		{"n":"新疆","c":["乌鲁木齐市","克拉玛依市"]},
		{"n":"内蒙古","c":["呼和浩特","包头","乌海","赤峰","通辽","鄂尔多斯","呼伦贝尔","乌兰察布","锡林郭勒盟","巴彦淖尔","阿拉善盟","兴安盟"]},
		{"n":"香港","c":["香港岛","九龙","新界东","新界"]},
		{"n":"澳门","c":["澳门半岛","氹仔","路环"]}
	];
 
C.initProv = function(prov, city, defaultProv, defaultCity) {
    var provEl = $("#"+prov);
    var cityEl = $("#"+city);
    ...
    provHtml += '<option value="-1" selected="selected">请选择</option>';
    for(var i = 0; i < C._cityInfo.length; i++) {
        provHtml += '<option value="' + i + '"' + ((hasDefaultProv && C._cityInfo[i].n == defaultProv) ? ' selected="selected"' : '') + '>' + C._cityInfo[i].n + '</option>';
    }
    provEl.html(provHtml);
    C.initCities(provEl, cityEl, defaultCity);
    provEl.change(function() {
        C.initCities(provEl, cityEl);
    });
};
C.initCities = function(provEl, cityEl, defaultCity) {
    var hasDefaultCity = (typeof(defaultCity) != 'undefined');
    if(provEl.val() != '' && parseInt(provEl.val()) >= 0) {
        var cities = C._cityInfo[parseInt(provEl.val())].c;
        var cityHtml = '';
