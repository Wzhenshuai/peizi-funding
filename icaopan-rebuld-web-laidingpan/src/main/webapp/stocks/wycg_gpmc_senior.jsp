...
<div id="main">
	<div class="wrap clearfix">
		...
		<div class="main-cont fr">
			<div class="ac-title">
				<div style="float:left;"><h2 class="ac-title">股票卖出</h2></div>
				<div style="float:right;padding-right:30px;font-size:14px;" class="nihao"><a style="" href='javascript:;' onclick="MS.queryStockAccount()">刷新资金</a></div>
			</div>
			...
			<div class="stocks-info-wrap MT16 clearfix">
				<div class="stocks-info fl">
					<table>
						...
						<tr><td style="vertical-align: top;padding-top:0px">交易通道：</td>
						<td class="ntb">
			...
			<div class="tab_plugin MT16">
				...
				<div class="tab_plugin_list hide">
					<table class="S-wtjl" id="holdStockTable">
						<tr><th width="100">股票简称</th><th width="115">股票市值</th><th width="128">浮动盈亏/比例</th><th width="120">持股/可用</th><th width="90">现价</th><th width="90">成本价</th><th></th></tr>
					</table>
					<div class="txt-c MT42 digg"></div>
				</div>
			</div>
...
<script>
$(function(){
	$(".aside-nav li a:contains('高级股票卖出')").parent("li").addClass('active');
});
</script>
...
<script type="text/javascript" src="<%=basePath%>js/util/icp-dialog.js?<%= System.currentTimeMillis()%>"></script>
...
<script type="text/javascript" src="<%=basePath%>js/stock.js?<%= System.currentTimeMillis()%>"></script>
...
<script type="text/javascript" src="<%=basePath%>/js/moment.js?<%= System.currentTimeMillis()%>"></script>
