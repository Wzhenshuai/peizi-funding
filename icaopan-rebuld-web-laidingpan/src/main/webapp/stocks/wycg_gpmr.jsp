		...
		<div class="wrap clearfix">
			...
			<div class="main-cont fr">
				...
				<div class="stocks-info fl">
					<table>
						<div id="forbid-wrap">
							<i class="forbid-coner"></i>
							<i class="forbid-close pointer"></i>
							<h3>今日禁买股</h3>
							<div class="clearfix">
								<div class="forbid-list-wrap fl">
									<ul id="forbid-list"></ul>
								</div>
								<div class="forbid-instruction fr">
									<p>其他禁买范围</p>
									<ol>
										<li>S、 ST、 *ST、 S*ST、 SST以及被交易所特别处理的股票</li>
										<li>不得购买权证类可以T+0交易 的证券</li>
										<li>不得购买首日上市新股（或复牌首日股票）等当日不设涨跌停板限制的股票</li>
										<li>不得购买或持有基金类产品</li>
									</ol>
								</div>
							</div>
