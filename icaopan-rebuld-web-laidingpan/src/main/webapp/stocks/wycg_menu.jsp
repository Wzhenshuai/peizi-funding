...
<div class="aside-nav fl">
	<ul>
		<li>
			<a href="<%=basePath%>trade/StocksIndex.do">总资产</a>
		</li>
		<li>
			<a href="<%=basePath%>trade/BuyStocksInit.do">买入</a>
		</li>
		<li>
			<a href="<%=basePath%>trade/SellStocksInit.do">卖出</a>
		</li>
		<% 
			if("1".equals(type)||"senior".equals(user_type)){
		%>
			<li>
			<a href="<%=basePath%>trade/BuyStocksInitSenior.do">高级买入</a>
			</li>
			<li>
				<a href="<%=basePath%>trade/SellStocksInitSenior.do">高级卖出</a>
			</li>
		<% 		
			}
		%>
		...
		<li>
			<a href="<%=basePath%>trade/CancelStocksInit.do">撤单</a>
		</li>
		<li>
			<a href="<%=basePath%>trade/QueryHoldStocksInit.do">持仓</a>
		</li>
		<li>
